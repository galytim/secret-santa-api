class Box < ApplicationRecord
    ...
    def self.present_box(box, current_user)
        ...
        box_data = box.attributes.except('created_at', 'updated_at', 'image_data')
        box_data.merge(current_user_admin: isCurrentUserAdmin, is_started: isStarted,image_url: box.image_url)
    end
